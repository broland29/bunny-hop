...
import game_domain.model.persistence.GameMapper as GM
import user_domain.model.persistence.UserMapper as UM
...
class GameDAO:
    ...
    # inserts a game_domain into the database based on input game_domain object
    ...
    # returns a list of game_domain objects reflecting the games of a given user
