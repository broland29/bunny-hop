...
class RegistrationValidator:
    ...
    def validate(username, password1, password2):
        ...
        valid_username, username_message = RegistrationValidator.validate_username(username)
        if not valid_username:
            return False, username_message

        valid_password, password_message = RegistrationValidator.validate_password(password1, password2)
